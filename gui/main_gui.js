function start_main_gui(div_id,width,height,pendulum)
  {
...
*/
		...
		let x3 = {id:"ghult", name: "driving force", range: [0,2], value: pendulum.pendulum_integrator.driving_force};


		let sliders = [
			widget.slider(x3).update(function(){
        pendulum.set_parameters({driving_force: x3.value}); 
        d3.selectAll("#driving-force-show").text("γ = "+d3.format(".2f")(x3.value));
      })
		]

		let sliderbox = g.block({x0:1,y0:8,width:22,height:1}).Ny(2);
